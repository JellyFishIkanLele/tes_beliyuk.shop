...
function sendProductEmail($toEmail, $orderId, $productName, $amount) {
    $subject = "✅ 48 Laws of Power E-BOOKS (indo)A nda Telah Siap - Order #" . $orderId;
    ...
    <head>
        <meta charset="UTF-8">
        <title>48 Laws of Power E-BOOKS(indo) Anda</title>
        <style>
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <p>48 Laws of Power E-BOOKS(indo)  Premium</p>
            </div>
