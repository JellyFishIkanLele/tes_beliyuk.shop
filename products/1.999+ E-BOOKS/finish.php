...
// NAMA PRODUK
// ==========================
$productName = "1.999+ E-BOOKS (indo)";
...
// ==========================
$pricePerItem = 499999; // Harga per paket
$quantity = 1; // Default
...
<script type="application/ld+json">
{
  ...
  "offers": {
    ...
    "url": "https://beliyuk.shop/products/1.999+%20E-BOOKS/finish.php?merchantOrderId=<?= $merchantOrderId ?>",
    "priceCurrency": "IDR",
    "price": "<?= $amountAPI ?>",
...
<div itemscope itemtype="http://schema.org/Product" style="display:none;">
  <meta itemprop="url" content="https://beliyuk.shop/products/1.999+%20E-BOOKS/finish.php?merchantOrderId=<?= $merchantOrderId ?>">
  <meta itemprop="name" content="Paket 1.999+ E-BOOKS (indo)">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const PRODUCT_CATALOG_DATA = {
        id: '72e1rdnnrd',
        sku: '72e1rdnnrd',
        title: 'Paket 1.999+ E-BOOKS (indo)',
