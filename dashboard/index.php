<?php
// ====================================================
// DASHBOARD ADMIN BELIYUK.SHOP - FIXED VERSION
// ====================================================
...
<body>
    ...
    <div class="modal fade" id="addProductModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="process_product.php" method="POST" id="addProductForm">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="title" id="add_title" required 
                                           pattern="[a-zA-Z0-9\-_]+"
                                           title="Hanya huruf, angka, dash (-), underscore (_). TIDAK BOLEH SPASI!"
                                           placeholder="Contoh: Atomic-Habits_EBOOK atau AtomicHabits2024">
                                    <small class="text-muted">
                                        <i class="fas fa-info-circle"></i> Hanya huruf (A-Z a-z), angka (0-9), dash (-), underscore (_). 
                                        <strong class="text-danger">TIDAK BOLEH SPASI!</strong>
                                    </small>
                                    <div class="invalid-feedback title-error" style="display:none;"></div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Harga (Rp) <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text">Rp</span>
                                        <input type="number" class="form-control" name="price" id="add_price" min="1000" required 
                                               placeholder="149999">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Stok <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="stock" id="add_stock" min="0" value="10" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control" name="image_url" id="add_image_url"
                                           value="https://imgdst.tomsamcong.com/public/uploads/original/65/6b/35ef31fbe97ddeb5f4f18a04c1b7.webp"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" id="add_description" rows="4" required 
                                      placeholder="Deskripsi lengkap produk minimal 10 karakter..."></textarea>
                        </div>
                        
                        <!-- Hidden input untuk tombol submit -->
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="submit_add" id="submit_add_btn">
    ...
    <!-- ============================================
    MODAL EDIT PRODUK LENGKAP (FIXED)
    ============================================ -->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">
                                                ...
                                                Contoh: <code>nama-produk</code>
                                            </small>
                                            <div class="invalid-feedback folder-error" style="display:none;"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
  ...
  ...
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.addEventListener('click', function(e) {
                if (e.target.classList.contains('btn-edit') || e.target.closest('.btn-edit')) {
                    ...
                    document.getElementById('edit_image_url').value = button.dataset.image_url || 
                        'https://imgdst.tomsamcong.com/public/uploads/original/65/6b/35ef31fbe97ddeb5f4f18a04c1b7.webp';
                    
                    // Set folder info
                    const folderName = button.dataset.folder_name || '';
                    ...
                    document.getElementById('edit_meta_image_url').value = button.dataset.meta_image_url || 
                        'https://imgdst.tomsamcong.com/public/uploads/original/65/6b/35ef31fbe97ddeb5f4f18a04c1b7.webp';
                    document.getElementById('edit_og_type').value = button.dataset.og_type || 'product';
                    document.getElementById('edit_og_image_width').value = button.dataset.og_image_width || '1200';
                    document.getElementById('edit_og_image_height').value = button.dataset.og_image_height || '630';
                    document.getElementById('edit_og_image_alt').value = button.dataset.og_image_alt || '';
                    document.getElementById('edit_og_site_name').value = button.dataset.og_site_name || 'Beliyuk Shop';
                    
                    // Set Meta Catalog data
                    document.getElementById('edit_product_sku').value = button.dataset.product_sku || '';
                    document.getElementById('edit_product_brand').value = button.dataset.product_brand || 'Beliyuk Shop';
                    document.getElementById('edit_retailer_item_id').value = button.dataset.retailer_item_id || '';
                    document.getElementById('edit_availability').value = button.dataset.availability || 'in stock';
                    document.getElementById('edit_condition').value = button.dataset.condition || 'new';
                    document.getElementById('edit_price_currency').value = button.dataset.price_currency || 'IDR';
                    document.getElementById('edit_sale_price_amount').value = button.dataset.sale_price_amount || button.dataset.price;
                    document.getElementById('edit_original_price_amount').value = button.dataset.original_price_amount || button.dataset.price;
                    document.getElementById('edit_item_group_id').value = button.dataset.item_group_id || '';
                    document.getElementById('edit_product_category').value = button.dataset.product_category || 'Media > Books > E-books';
                    
                    // Set Structured Data
                    document.getElementById('edit_structured_data_json').value = button.dataset.structured_data_json || 
                        generateDefaultStructuredData(button.dataset);
                    document.getElementById('edit_microdata_html').value = button.dataset.microdata_html || 
                        generateDefaultMicrodata(button.dataset);
                    
                    // Show modal
                    const editModal = new bootstrap.Modal(document.getElementById('editProductModal'));
                    editModal.show();
                    
                    // Validate title after setting value
                    setTimeout(() => {
                        validateTitleInput(document.getElementById('edit_title'), 'edit');
                    }, 100);
                }
            });
            ...
            document.addEventListener('click', function(e) {
                if (e.target.classList.contains('btn-delete') || e.target.closest('.btn-delete')) {
                    ...
                    const folderName = button.closest('tr').querySelector('td:nth-child(7) small')?.textContent?.replace('...', '') || 'N/A';
                    
                    document.getElementById('confirm_delete').href = `process_product.php?delete=${productId}`;
                    
                    // Update modal message dengan info folder
                    const modalBody = document.getElementById('deleteModalBody');
                    modalBody.innerHTML = `
                        <p>Hapus produk <strong>${productTitle}</strong>?</p>
                        <div class="alert alert-danger">
                            <i class="fas fa-exclamation-triangle me-2"></i>
                            <strong>PERINGATAN:</strong> Tindakan ini akan menghapus:
                            <ul class="mb-0 mt-2">
                                <li>Data produk dari database</li>
                                <li>Folder produk: <code>${folderName}</code></li>
                                <li>File di: <code>beliyuk.shop/products/${folderName}/</code></li>
                            </ul>
                        </div>
        ...
        // REAL-TIME VALIDATION UNTUK TITLE - TANPA SPASI
        const addTitleInput = document.querySelector('#addProductModal [name="title"]');
        if (addTitleInput) {
            addTitleInput.addEventListener('input', function(e) {
                validateTitleInput(this, 'add');
            });
            
            addTitleInput.addEventListener('blur', function(e) {
                validateTitleInput(this, 'add');
            });
        }
        
        // REAL-TIME VALIDATION UNTUK TITLE EDIT - TANPA SPASI
        const editTitleInput = document.querySelector('#editProductModal [name="title"]');
        if (editTitleInput) {
            editTitleInput.addEventListener('input', function(e) {
                validateTitleInput(this, 'edit');
            });
        ...
        // Fungsi validasi title
        function validateTitleInput(inputElement, formType) {
            const value = inputElement.value;
            const errorDiv = inputElement.parentElement.querySelector('.title-error') || 
                             createErrorElement(inputElement.parentElement, 'title-error');
            
            // Validasi regex - TANPA SPASI
            if (!/^[a-zA-Z0-9\-_]*$/.test(value)) {
                errorDiv.textContent = 'Hanya boleh huruf (A-Z a-z), angka (0-9), dash (-), underscore (_). TIDAK BOLEH SPASI atau karakter khusus lain!';
                errorDiv.style.display = 'block';
                inputElement.classList.add('is-invalid');
                return false;
            }
            
            // Validasi tidak boleh hanya dash/underscore
            if (/^[\-_]+$/.test(value)) {
                errorDiv.textContent = 'Tidak boleh hanya berisi dash (-) atau underscore (_)!';
                errorDiv.style.display = 'block';
                inputElement.classList.add('is-invalid');
                return false;
            }
            
            // Validasi panjang minimum (hanya saat submit)
        ...
        // REAL-TIME VALIDATION UNTUK FOLDER NAME DI MODAL EDIT
        const folderNameInput = document.querySelector('#editProductModal [name="folder_name"]');
        if (folderNameInput) {
            folderNameInput.addEventListener('input', function(e) {
                const value = this.value;
                const errorDiv = this.parentElement.querySelector('.folder-error') || 
                                 createErrorElement(this.parentElement, 'folder-error');
                
                // TANPA SPASI, hanya lowercase
                if (!/^[a-z0-9\-_]*$/.test(value)) {
                    errorDiv.textContent = 'Hanya boleh huruf kecil, angka, dash (-), underscore (_). TIDAK BOLEH SPASI atau huruf besar!';
                    errorDiv.style.display = 'block';
        ...
        // Helper function untuk membuat elemen error
        function createErrorElement(parentElement, className = 'title-error') {
            const errorDiv = document.createElement('div');
            errorDiv.className = `invalid-feedback ${className}`;
            errorDiv.style.display = 'none';
        ...
        function generateFolderName() {
            ...
            // Validasi input title - TANPA SPASI
            if (!/^[a-zA-Z0-9\-_]+$/.test(title)) {
                alert('ERROR: Title mengandung karakter yang tidak diizinkan atau spasi!\\n\\nHanya boleh:\\n• Huruf (A-Z a-z)\\n• Angka (0-9)\\n• Dash (-)\\n• Underscore (_)\\n\\nTIDAK BOLEH SPASI!');
                return;
            }
            
            // Validasi tidak boleh hanya dash/underscore
            if (/^[\-_]+$/.test(title)) {
                alert('ERROR: Title tidak boleh hanya berisi dash (-) atau underscore (_)!');
                return;
            }
            
            // Generate folder name - TANPA SPASI
            let folderName = title.toLowerCase()
                .replace(/[^a-z0-9\-_]/g, '') // Hanya huruf, angka, dash, underscore
                .replace(/-+/g, '-')          // Hapus multiple dash
                .replace(/_+/g, '_')          // Hapus multiple underscore
                .replace(/^[\-_]+|[\-_]+$/g, ''); // Trim dash/underscore di awal/akhir
            
            // Batasi panjang
            folderName = folderName.substring(0, 50);
            
            // Validasi folder name tidak kosong
            if (!folderName) {
                alert('ERROR: Tidak dapat membuat nama folder dari judul ini.\\nGunakan karakter yang valid.');
                return;
            }
            ...
            showAlert('Nama folder berhasil digenerate!', 'success');
        }
    ...
    <meta itemprop="itemCondition" content="https://schema.org/NewCondition">
        ...
        document.getElementById('addProductForm')?.addEventListener('submit', function(e) {
            ...
            if (title.value.length < 3) {
                e.preventDefault();
                alert('ERROR: Judul produk minimal 3 karakter!');
                title.focus();
                return false;
            }
            ...
            if (!desc.value || desc.value.length < 10) {
                e.preventDefault();
                alert('ERROR: Deskripsi minimal 10 karakter!');
                desc.focus();
                return false;
            }
            
            // Show loading
            const submitBtn = this.querySelector('[name="submit_add"]');
        ...
        document.getElementById('editProductForm')?.addEventListener('submit', function(e) {
            ...
            const originalText = submitBtn.innerHTML;
            submitBtn.innerHTML = '<span class="loading"></span> Memperbarui...';
            submitBtn.disabled = true;
